...
export declare class FinsClient {
   ...
   */
  readStruct(area: string, address: number, types: Array<string>): Promise<Array<JsPlcValue>>
  /**
   ...
   */
  writeStruct(area: string, address: number, values: Array<JsPlcValue>): Promise<void>
}
